...
const ChooseUs = () => {
    return (
        <div className='m-10 md:px-10 mx-auto max-w-screen-xl md:pt-10 rounded-xl bg-[#f5f5f5]'>
            <div>
                <div>
                    <h2 className='text-4xl font-bold text-center p-3'>Why Choose Us?</h2>
                    <h5 className='text-center md:px-40'>Select us for excellent service and a tranquil setting. You will receive customized treatments from our skilled therapists, who will make sure you depart feeling renewed and invigorated. Our top priority is your well-being.</h5>
                </div>
                <div className='grid gap-2  md:grid-cols-4 py-20'>
                    <div className='flex flex-col items-center gap-2'>
                        <span className='font-bold text-[30px] text-blue-light bg-gray-300  p-4 text-center rounded-full'>
                        ...
                        <h2 className='font-bold text-[20px]'>Services Done</h2>
                        <h2 className='font-bold text-[20px]'>1000+</h2>
                    </div>
                    <div className='flex flex-col items-center gap-2'>
                        <span className='font-bold text-[30px] text-blue-light bg-gray-300  p-4 text-center rounded-full'>
                        ...
                        <h2 className='font-bold text-[20px]'>Active User</h2>
                        <h2 className='font-bold text-[20px]'>1M</h2>
                    </div>
                    <div className='flex flex-col items-center gap-2'>
                        <span className='font-bold text-[30px] text-blue-light bg-gray-300  p-4 text-center rounded-full'>
                        ...
                        <h2 className='font-bold text-[20px]'>Professional Expert</h2>
                        <h2 className='font-bold text-[20px]'>200+</h2>
                    </div>
                    <div className='flex flex-col items-center gap-2'>
                        <span className='font-bold text-[30px] text-blue-light bg-gray-300  p-4 text-center rounded-full'>
                        ...
                        <h2 className='font-bold text-[20px]'>Online Support</h2>
                        <h2 className='font-bold text-[20px]'>24 hours</h2>
                    </div>
